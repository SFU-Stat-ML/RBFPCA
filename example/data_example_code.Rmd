...
#PACE.FPC[, 4] <- -1 * PACE.FPC[, 4] # flip PCs for comparison if needed
...
PACE.FPC <- PACE.FPCA$phi
#PACE.FPC[, c(1,2,4)] <- -1 * PACE.FPC[, c(1,2,4)]  # flip PCs for comparison if needed
...
#ggarrange(a, b, nrow = 1, ncol = 2, common.legend = TRUE)
...
PACE.FPC <- PACE.FPCA$phi
#PACE.FPC[, 2] <- -1 * PACE.FPC[, 2] # flip PCs for comparison if needed
